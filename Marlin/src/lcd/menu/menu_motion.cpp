...
// extern  screenFunc_t currentScreen; // Initialized in CTOR
// extern  screenFunc_t MarlinUI::prevScreen; // Initialized in CTOR
...
void menu_move() {  
  ...
  // MarlinUI::draw_right_panel(currentScreen);
  // START_MENU();
...
void menu_motion() {
  // TFT_FillScreen(0xFF231F20,BUFFER_LAYER);
  // MarlinUI::draw_right_panel(false);
// u8g.drawBitmapP(RIGHT_PANEL_HOME_X, RIGHT_PANEL_HOME_Y, RIGHT_PANEL_HOME_BYTEWIDTH, RIGHT_PANEL_HOME_HEIGHT,  (uint8_t*)image_data_right_panel_home);
