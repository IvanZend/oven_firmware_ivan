...
void MarlinUI::menu_camera() {
  prevScreen = currentScreen;
   HAL_LTDC_SetAddress(&hltdc,LCD_FRAME_BUFFER(LAYER_CAM), 0);
}

void MarlinUI::draw_menu_camera() {


  // uint8_t drawLayer = LAYER_CAM;
  // uint8_t backLayer = LAYER_CAM;

  
  TFT_FillScreen(0xFF231F20,LAYER_CAM);
  draw_right_panel(menu_camera);
