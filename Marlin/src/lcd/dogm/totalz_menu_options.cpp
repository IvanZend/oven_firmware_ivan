...
void MarlinUI::menu_options() {
  prevScreen = currentScreen;
   HAL_LTDC_SetAddress(&hltdc,LCD_FRAME_BUFFER(LAYER_OPT), 0);
}

void MarlinUI::draw_menu_axis() {


  // uint8_t drawLayer = LAYER_OPT;
  // uint8_t backLayer = LAYER_OPT;

  
  TFT_FillScreen(0xFF231F20,LAYER_OPT);
  draw_right_panel(menu_axis);
