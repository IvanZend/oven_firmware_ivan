...
// REPRAPWORLD_KEYPAD (and ADC_KEYPAD)
  ...
  #define EN_1 (_BV(BLEN_D)+11)
  #define EN_2 (_BV(BLEN_D)+12)
  #define EN_3 (_BV(BLEN_D)+13)
  #define EN_4 (_BV(BLEN_D)+14)
  #define EN_5 (_BV(BLEN_D)+15)
  #define EN_6 (_BV(BLEN_D)+16)
  #define EN_7 (_BV(BLEN_D)+17)
  #define EN_8 (_BV(BLEN_D)+18)
  #define EN_9 (_BV(BLEN_D)+19)
  #define EN_0 (_BV(BLEN_D)+20)
...
public:
  ...
  MarlinUI() {
      ...
      prevScreen        = NULL;
      iconsReady        = false; // Initialized in CTOR
      DrawPhaseOne      = false; // Initialized in CTOR
      DrawPhaseTwo      = false; // Initialized in CTOR
      hotendActive      = 0; // Initialized in CTOR
      hotendActive0      = false; // Initialized in CTOR
      hotendActive1      = false; // Initialized in CTOR
      calibstate        = EXTR1;
      calibstate_old    = BED;
      edited_settings   = 0;
      bedActive         = false; // Initialized in CTOR
      chamberActive     = false; // Initialized in CTOR
  ...
  // LCD implementations
  static void clear_lcd(uint8_t layer);
  static void init_lcd();
    ...
    static void resume_print();
      ...
      static millis_t edited_timer_ms;
      ...
      static void quick_feedback(const bool clear_buttons=true);
        ...
        static void draw_status_message(const bool blink, bool redrawall,uint8_t textLayer, uint8_t backLayer);
      #endif
     
      static void draw_right_panel(screenFunc_t blink);
      ...
      static screenFunc_t get_screen();
      static void home_sd_rewrite();
      static void home_recovery_rewrite();
      static void status_screen_refresh();
      static void edit_calib_val(int i);
      static void pm_calib_val(int i);
      static void edic_calib_ok();
      static void edic_calib_back();
      static void edic_calib_cancel();

      static void menu_calib();
      static void menu_options();
      static void menu_light();
      static void menu_camera();
      static void menu_filament();
      static void menu_axis();

      static void menu_sdmain();
      static void menu_sdmain_refresh();
      static void menu_recovery();
    ...
    static screenFunc_t prevScreen;
    static bool DrawPhaseOne; // Initialized in CTOR
    static bool DrawPhaseTwo; // Initialized in CTOR
    static bool iconsReady; // Initialized in CTOR
    static uint8_t hotendActive; // Initialized in CTOR
    static uint8_t percent; // Initialized in CTOR
    static int16_t edited_settings; // Initialized in CTOR
    static bool hotendActive0; // Initialized in CTOR
    static bool hotendActive1; // Initialized in CTOR
    static CALeditState calibstate; // Initialized in CTOR
    static CALeditState calibstate_old; // Initialized in CTOR
    static bool bedActive; // Initialized in CTOR
    static bool chamberActive; // Initialized in CTOR
    static bool screen_changed;
    static uint8_t opt_disctance;
...
private:
  ...
  static bool delta_z_available_old;
  static bool delta_z_available_new;
  static void _synchronize();
    ...
    static void finish_status(const bool persist);
      ...
      #endif
    #endif
    static void menu_calib_set_active(int item);
    static void menu_calib_refresh();
    static void menu_options_refresh();
    static void menu_axis_refresh();


    static void draw_status_screen();
    static void draw_menu_calib();
    static void draw_menu_options();
    static void draw_menu_light();
    static void draw_menu_camera();
    static void draw_menu_filament();
    static void draw_menu_axis();

    static void draw_menu_recovery();
    static void draw_menu_sdmain();
  #endif
};
