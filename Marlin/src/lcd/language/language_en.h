...
namespace Language_en {
  ...
  PROGMEM Language_Str MSG_NOT_ENOUGH_LAYERS               = _UxGT("Need to enable 4 layers");
  PROGMEM Language_Str MSG_SDRAM1_NOT_INIT                 = _UxGT("SDRAM1 init error");
  PROGMEM Language_Str MSG_SDRAM2_NOT_INIT                 = _UxGT("SDRAM2 init error");
}
