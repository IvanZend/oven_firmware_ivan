...
namespace Language_ru {
  ...
  PROGMEM Language_Str MSG_NOT_ENOUGH_LAYERS               = _UxGT("Включите 4 слоя в настройках");
  PROGMEM Language_Str MSG_SDRAM1_NOT_INIT                 = _UxGT("Ошибка инициализации SDRAM1");
  PROGMEM Language_Str MSG_SDRAM2_NOT_INIT                 = _UxGT("Ошибка инициализации SDRAM2");
  PROGMEM Language_Str MSG_FORMAT_UNSUPPORTED              = _UxGT("формат накопителя не поддерживается");
