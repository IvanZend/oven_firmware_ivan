...
#ifndef HEAT_TIMER_IRQ_PRIO
  #define HEAT_TIMER_IRQ_PRIO 4   // 
#endif

#ifndef PWM_TIMER_IRQ_PRIO
  #define PWM_TIMER_IRQ_PRIO 12   // 
#endif
...
#define HEAT_TIMER_IRQ_NAME                                                   _TIMER_IRQ_NAME(HEAT_TIMER)
#define PWM_TIMER_IRQ_NAME                                                    _TIMER_IRQ_NAME(PWM_TIMER)
...
#define ENABLE_HEATER_INTERRUPT()                                             HAL_timer_enable_interrupt(HEAT_TIMER_NUM)
#define DISABLE_HEATER_INTERRUPT()                                            HAL_timer_disable_interrupt(HEAT_TIMER_NUM)
...
extern void Pwm_Handler(HardwareTimer *htim);
