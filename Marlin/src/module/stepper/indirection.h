...
#ifndef Y_STEP_WRITE
  // #define Y_STEP_WRITE(STATE) HAL_GPIO_TogglePin(GPIOC, GPIO_PIN_14)//WRITE(Y_STEP_PIN,STATE)
...
//
    ...
    #define  ENABLE_STEPPER_E2() do{driver_onoff(1,E2_AXIS, E2_ENABLE_GPIO_Port, E2_ENABLE_Pin_MX, spiSend)
  #else
  ...
  #if E_STEPPERS > 2 && HAS_E2_ENABLE
    #define DISABLE_STEPPER_E2() do{driver_onoff(0,E2_AXIS, E2_ENABLE_GPIO_Port, E2_ENABLE_Pin_MX, spiSend)
  #else
