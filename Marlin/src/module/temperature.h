...
typedef struct TempInfo {
  uint32_t acc;
  int32_t raw;
  int32_t raw_100_mid = 0;
  int32_t raw_OLD[100];
  int32_t raw_MAX = 0;
  int32_t raw_MIN = 65535;
  int32_t raw_count1 = 0;
  int32_t raw_count2 = 0;
  float celsius;
...
class Temperature {
  ...
  public:
     ...
     */
      ...
      static constexpr inline uint8_t fanUnits(const uint8_t speed) { return percent_to_ui8(speed); }
    ...
    static void manage_pwm() _O2; // Added _O2 to work around a compiler error
  ...
  private:
    ...
    #define HAS_ADS1118 ANY(HEATER_0_USES_ADS1118, HEATER_1_USES_ADS1118, HEATER_2_USES_ADS1118)
    #if HAS_ADS1118
      #if ALL(HEATER_0_USES_ADS1118, HEATER_1_USES_ADS1118, HEATER_2_USES_ADS1118)
        #define COUNT_1118 3
      #elif BOTH(HEATER_0_USES_ADS1118, HEATER_1_USES_ADS1118)
        #define COUNT_1118 2
      #elif BOTH(HEATER_1_USES_ADS1118, HEATER_2_USES_ADS1118)
        #define COUNT_1118 2
      #elif BOTH(HEATER_2_USES_ADS1118, HEATER_0_USES_ADS1118)
        #define COUNT_1118 2
      #else 
        #define COUNT_1118 1
      #endif
      ...
      #if COUNT_1118 > 1
        #define READ_ADS1118(N) read_ads1118(N)
      #else
        #define READ_ADS1118(N) read_ads1118()
      #endif

      static int read_ads1118(
        #if COUNT_1118 > 1
