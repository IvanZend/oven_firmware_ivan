...
#if MAX_LAYER!=17
  #error "MAX_LAYER must be 17, correct it in `stm32f4xx_hal_ltdc.h` file"
#endif
/**
 * Progress Bar
 */
...
#if ENABLED(HEATER_0_USES_MAX6675) && !PIN_EXISTS(MAX6675_SS_1)
  #error "MAX6675_SS_1_PIN (required for TEMP_SENSOR_0) not defined for this board."
#elif (HOTENDS > 1 || ENABLED(HEATERS_PARALLEL)) && !HAS_HEATER_1
  #error "HEATER_1_PIN not defined for this board."
#endif

#if HOTENDS > 1
  #if ENABLED(HEATER_1_USES_MAX6675) && !PIN_EXISTS(MAX6675_SS_2)
    #error "MAX6675_SS_2_PIN (required for TEMP_SENSOR_1) not defined for this board."
  #elif TEMP_SENSOR_1 == 0
    #error "TEMP_SENSOR_1 is required with 2 or more HOTENDS."
  #elif !ANY_PIN(TEMP_1, ADS_CS1)
    #error "TEMP_1_PIN not defined for this board."
  #elif ENABLED(TEMP_SENSOR_1_AS_REDUNDANT)
    #error "HOTENDS must be 1 with TEMP_SENSOR_1_AS_REDUNDANT."
  #endif
  #if HOTENDS > 2
    #if ENABLED(HEATER_2_USES_MAX6675) && !PIN_EXISTS(MAX6675_SS_3)
      #error "MAX6675_SS_3_PIN (required for TEMP_SENSOR_2) not defined for this board."
    #elif TEMP_SENSOR_2 == 0
      #error "TEMP_SENSOR_2 is required with 3 or more HOTENDS."
    #elif !HAS_HEATER_2
      #error "HEATER_2_PIN not defined for this board."
    #elif !ANY_PIN(TEMP_2, ADS_CS2)
