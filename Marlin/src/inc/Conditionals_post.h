...
#define HEATER_0_DUMMY 0  
#define HEATER_1_DUMMY 0
#define HEATER_2_DUMMY 0
  ...
  #define HEATER_0_USES_MAX6675
    ...
    #define HEATER_0_MAX6675_TMAX 2048
  #endif
  #if TEMP_SENSOR_0 == -5
  ...
  #endif
#elif TEMP_SENSOR_0 == -6
  #define HEATER_0_USES_ADS1118
  #define HEATER_0_ADS1118_TMIN -9999
  #define HEATER_0_ADS1118_TMAX  9999
  ...
  #define HEATER_0_USES_THERMISTOR
    ...
    #undef HEATER_0_DUMMY
    #define HEATER_0_DUMMY 1
  #endif
#else
  ...
  #define HEATER_1_USES_MAX6675
    ...
    #define HEATER_1_MAX6675_TMAX 2048
  #endif
  ...
  #define HEATER_1_ADS1118_TMIN -9999
  #define HEATER_1_ADS1118_TMAX  9999
  ...
  #define HEATER_1_USES_THERMISTOR
    ...
    #undef HEATER_1_DUMMY
    #define HEATER_1_DUMMY 1
  #endif
#else
...
#if TEMP_SENSOR_2 == -5 || TEMP_SENSOR_2 == -3 || TEMP_SENSOR_2 == -2
  #define HEATER_2_USES_MAX6675
    ...
    #define HEATER_2_MAX6675_TMAX 2048
  #endif
    ...
    #endif
  #endif
#elif TEMP_SENSOR_2 == -6
  #define HEATER_2_USES_ADS1118
  #define HEATER_2_ADS1118_TMIN -9999
  #define HEATER_2_ADS1118_TMAX  9999
  ...
  #define HEATER_2_USES_THERMISTOR
    ...
    #undef HEATER_2_DUMMY
    #define HEATER_2_DUMMY 1
  #endif
#else
...
#define HAS_TEMP_HOTEND   ((HAS_TEMP_ADC_0 || HEATER_0_DUMMY || ENABLED(HEATER_0_USES_MAX6675) || ENABLED(HEATER_0_USES_ADS1118)) && HOTENDS)
...
// LCD timeout to status screen default is 15s
  ...
  #define LCD_TIMEOUT_TO_STATUS 0//15000
#endif
