...
static inline uint8_t DIR_IS_SUBDIR_FF(FILINFO* dir) {
  return (dir->fattrib & DIR_ATT_FILE_TYPE_MASK) == DIR_ATT_DIRECTORY;
}
...
static inline uint8_t DIR_IS_FILE_OR_SUBDIR_FF(FILINFO* dir) {
  return (dir->fattrib & DIR_ATT_VOLUME_ID) == 0;
}
