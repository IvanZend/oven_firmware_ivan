...
CMSIS_DIR = os.path.join("buildroot/share/PlatformIO/framework/arduinoststm32", "CMSIS", "CMSIS")
assert os.path.isdir("buildroot/share/PlatformIO/framework/arduinoststm32")
...
variant_dir = os.path.join("buildroot/share/PlatformIO/framework/arduinoststm32", "variants", variant)
